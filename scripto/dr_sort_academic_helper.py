...
try:
    from . import document_sorter as sorter
except ImportError:
...
APP_HEADER_SUBTITLE = "Professional archive sorter with detailed planning, review, and reporting."
...
class DrSortAcademicHelperApp(tk.Tk):
    ...
    def _build_ui(self) -> None:
        ...
        ops_frame.columnconfigure(6, weight=1)
